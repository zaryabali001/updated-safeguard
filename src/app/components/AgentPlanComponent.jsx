  ...
  return (
    ...
    >
      ...
      <div
        ...
        w-full max-w-md md:max-w-lg border border-gray-200 dark:border-gray-700 h-full"
      >
        ...
        <div className="relative w-56 sm:w-72 h-64 sm:h-96 mx-auto mt-6">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
            <Image src="/group.png" alt="Agent" width={60} height={60} />
          </div>

          {/* Labels */}
          <div className="absolute left-0 top-1/2 -translate-y-1/2">
            <div className="flex items-center gap-2">
              <div className="bg-blue-500 text-white px-3 py-1 rounded-md text-xs sm:text-sm shadow">
                Tool
              </div>
      ...
      >
        ...
        <div className="mt-8 space-y-4">
          <div className="flex items-center justify-center gap-3">
            <div className="bg-blue-500 text-white px-5 py-2 rounded-md text-xs sm:text-sm shadow">
              AI Agent Outputs
            </div>
          ...
          <div className="text-center text-sm font-medium text-gray-900 dark:text-gray-100 border-b border-gray-300 dark:border-gray-600 pb-2">
          ...
          <div className="text-center text-xs font-medium mt-3 text-gray-900 dark:text-gray-100 border-b border-gray-300 dark:border-gray-600 pb-2">
